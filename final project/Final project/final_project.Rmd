...
act_all_female %>% 
    ...
    kable(col.names = c("Reported Race", "n", "Percent"), caption = "Racial Demographics Self-Reported by Participants")
...
To accomplish this project and our analyses, we used @r and the @here, @rio, @janitor, @tidyverse, and @knitr packages. 
